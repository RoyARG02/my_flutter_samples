...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(                 // * MaterialApp denotes an application which follows the Material Design
        title: 'Class App',
        home: new Material(                 // * 'home' property takes a Widget which will be displayed first when the app is run
        // * Material provides properties to wrap Widgets following the Material Design
            color: Colors.black,            // * Colors in Flutter are part of the 'Colors' class
            child: new Center(              // * Center Widget forces its child widget to be positioned at the center of the screen 
                child: new Text(
                    'Hello_world.txt',
                    ...
                    style: new TextStyle(                 // * TextStyle class provides properties for stylizing the text
                        fontSize: 32,
